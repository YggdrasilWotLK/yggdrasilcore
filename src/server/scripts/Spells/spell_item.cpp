...
enum LuckyItemModifiers
{
    SPELL_LUCKY = 59125,
};

static const float MODIFIER_COPPER_COIN = 1.5f;
static const float MODIFIER_SILVER_COIN = 2.25f;
static const float MODIFIER_GOLD_COIN   = 3.0f;

static const uint32 CopperCoinIDs[] =
{
